...
@include('extensions/google/tagmanager')
	...
	<header>
		<div class="brand">
			<!-- Here Lay the Ornery Octopus, may his Soul be put to Rest - Voodoo Masta 2015 -->
			<div class="brand__image"><img src="{{ Asset::getUrl('img/logos/steel.png') }}" alt="Ornery Octopus"></div>
		</div>
	</header>
	...
	<section>
		...
		<div class="error">
			<div class="error__message">
				...
				<p>The requested page was not found; it may have existed at one time, or maybe it will exist soon...</p>
