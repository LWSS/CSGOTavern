	...
	<section>
		...
		<div class="error">
			<div class="error__message">
				...
				<h1>500</h1>
				<h2>Something went horribly horribly wrong!</h2>
				<p>What the application just said is one of the most insanely idiotic things we have ever heard. At no point in it's rambling, incoherent response did it even come close to anything that could be considered a rational thought.</p>
				<p>No logs were written, and may the gods have mercy on your soul.</p>
