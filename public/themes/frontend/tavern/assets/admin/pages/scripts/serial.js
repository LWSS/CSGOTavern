(function () {
    ...
    e.AmSerialChart = e.Class({
        inherits: e.AmRectangularChart, construct: function (a) {
            ...
            if (!this.wheelBusy) {
                var c = this.categoryAxis, d = c.parseDates, f = c.minDuration(), e = c = 1;
                this.mouseWheelZoomEnabled ? b || (c = -1) : b && (c = -1);
                var g = this.chartData.length, k = this.lastTime, m = this.firstTime;
                0 > a ? d ? (g = this.endTime - this.startTime, d = this.startTime + c * f, f = this.endTime + e * f, 0 < e && 0 < c && f >= k && (f = k, d = k - g), this.zoomToDates(new Date(d), new Date(f))) : (0 < e && 0 < c && this.end >= g - 1 && (c = e = 0), d = this.start +
                    c, f = this.end + e, this.zoomToIndexes(d, f)) : d ? (g = this.endTime - this.startTime, d = this.startTime - c * f, f = this.endTime - e * f, 0 < e && 0 < c && d <= m && (d = m, f = m + g), this.zoomToDates(new Date(d), new Date(f))) : (0 < e && 0 < c && 1 > this.start && (c = e = 0), d = this.start - c, f = this.end - e, this.zoomToIndexes(d, f))
            }
            ...
            if (0 < d && b - a < d) {
                var f = Math.round(a + (b - a) / 2), d = Math.round(d / 2);
                a = f - d;
                b = f + d
            }
            var h = this.chartData, f = this.categoryAxis;
            if (e.ifArray(h) && (a != this.startTime || b != this.endTime)) {
                ...
                b > k && (b = k);
                b < a && (b = a + g);
                b - a < g / 5 && (b < k ? b = a + g / 5 : a = b - g / 5);
                this.startTime = a;
                this.endTime = b;
                c = h.length - 1;
                g = this.getClosestIndex(h, "time", a, !0, 0, c);
                h = this.getClosestIndex(h, "time", b, !1, g, c);
                f.timeZoom(a, b);
                f.zoom(g, h);
                this.start = e.fitToBounds(g, 0, c);
            ...
            for (a = 0; a < b.length; a++) {
                ...
                if (d) {
                    var f;
                    for (f = 0; f < d.length; f++)this.columnsArray.push(d[f])
                }
            }
            ...
            var a = 0, b = this.valueAxes.length, c = this.graphs.length, d, e, h = !1, g, k;
            for (k = 0; k < b; k++) {
                e = this.valueAxes[k];
                var m = e.stackType;
                if ("100%" == m || "regular" == m)for (h = !1, g = 0; g < c; g++)d = this.graphs[g], d.tcc = 1, d.valueAxis == e && "column" == d.type && (!h && d.stackable && (a++, h = !0), (!d.stackable && d.clustered || d.newStack) && a++, d.columnIndex = a - 1, d.clustered || (d.columnIndex = 0));
                if ("none" == m || "3d" == m) {
                    h = !1;
                    for (g = 0; g < c; g++)d = this.graphs[g], d.valueAxis == e && "column" == d.type && (d.clustered ? (d.tcc = 1, d.newStack && (a = 0), d.hidden || (d.columnIndex = a, a++)) : d.hidden || (h = !0, d.tcc = 1, d.columnIndex = 0));
                    h && 0 === a && (a = 1)
                }
                if ("3d" == m) {
                    e = 1;
            ...
            var g = e + Math.round((h -
                    e) / 2), k = a[g][b];
            return c == k ? g : 1 >= h - e ? d ? e : Math.abs(a[e][b] - c) < Math.abs(a[h][b] - c) ? e : h : c == k ? g : c < k ? this.getClosestIndex(a, b, c, d, e, g) : this.getClosestIndex(a, b, c, d, g, h)
            ...
            if (b) {
                var c = ["value", "open", "low", "high", "close"], d = "value open low high close average sum count".split(" "), f = b.valueAxis, h = this.chartData, g = b.numberFormatter;
                g || (g = this.nf);
                for (var k = 0; k < c.length; k++) {
                    for (var m = c[k], l = 0, p = 0, q, n, x, y, w, r = 0, t = 0, A, v, u, B, C, I = this.start; I <= this.end; I++) {
                        var z = h[I];
                        if (z && (z = z.axes[f.id].graphs[b.id])) {
                            if (z.values) {
                                var D = z.values[m];
                                if (this.rotate) {
                                    if (0 > z.x || z.x > z.graph.height)D = NaN
                                } else if (0 > z.x || z.x > z.graph.width)D = NaN;
                                if (!isNaN(D)) {
                                    isNaN(q) && (q = D);
                                    n = D;
                                    if (isNaN(x) || x > D)x = D;
                                    if (isNaN(y) || y < D)y = D;
                                    w = e.getDecimals(l);
                                    var F = e.getDecimals(D), l = l + D, l = e.roundTo(l, Math.max(w, F));
                                    p++;
                                    w = l / p
                                }
                            }
                            if (z.percents && (z = z.percents[m], !isNaN(z))) {
                                isNaN(A) && (A = z);
                                v = z;
                                if (isNaN(u) || u > z)u = z;
                                if (isNaN(B) || B < z)B = z;
                                ...
                                D = e.getDecimals(z);
                                r += z;
                                r = e.roundTo(r, Math.max(C, D));
                                t++;
                                C = r / t
                            }
                        }
                    }
                    r = {open: A, close: v, high: B, low: u, average: C, sum: r, count: t};
                    a = e.formatValue(a, {
                        open: q,
                        close: n,
                        high: y,
                        ...
                        sum: l,
                        count: p
                    }, d, g, m + "\\.", this.usePrefixes, this.prefixesOfSmallNumbers, this.prefixesOfBigNumbers);
                    a = e.formatValue(a, r, d, this.pf, "percents\\." + m + "\\.")
                }
            }
            ...
            if (-1 != a.indexOf("[[category]]")) {
                var f = b.serialDataItem.category;
                if (this.categoryAxis.parseDates) {
                    var h = this.balloonDateFormat, g = this.chartCursor;
                    g && (h = g.categoryBalloonDateFormat);
                    -1 != a.indexOf("[[category]]") && (h = e.formatDate(f, h, this), -1 != h.indexOf("fff") && (h = e.formatMilliseconds(h, f)), f = h)
                }
                a = a.replace(/\[\[category\]\]/g, String(f))
            }
            f = d.numberFormatter;
            f || (f = this.nf);
            h = b.graph.valueAxis;
            (g = h.duration) && !isNaN(b.values.value) && (g = e.formatDuration(b.values.value, g, "", h.durationUnits, h.maxInterval, f), a = a.replace(RegExp("\\[\\[value\\]\\]", "g"), g));
            "date" == h.type && (h = e.formatDate(new Date(b.values.value), d.dateFormat, this), g = RegExp("\\[\\[value\\]\\]", "g"), a = a.replace(g, h), h = e.formatDate(new Date(b.values.open), d.dateFormat, this), g = RegExp("\\[\\[open\\]\\]", "g"), a = a.replace(g, h));
            d = "value open low high close total".split(" ");
            h = this.pf;
            a = e.formatValue(a, b.percents, d, h, "percents\\.");
            a = e.formatValue(a, b.values, d, f, "", this.usePrefixes, this.prefixesOfSmallNumbers, this.prefixesOfBigNumbers);
...
(function () {
    var e = window.AmCharts;
    e.Cuboid = e.Class({
        construct: function (a, b, c, d, e, h, g, k, m, l, p, q, n, x, y, w, r) {
            this.set = a.set();
            this.container = a;
            this.h = Math.round(c);
            this.w = Math.round(b);
            ...
            this.rotate = n;
            this.bcn = r;
            n ? 0 > b && 0 === p && (p = 180) : 0 > c && 270 == p && (p = 90);
            ...
            var a = this.set;
            a.clear();
            var b = this.container, c = b.chart, d = this.w, f = this.h, h = this.dx, g = this.dy, k = this.colors, m = this.alpha, l = this.bwidth, p = this.bcolor, q = this.balpha, n = this.gradientRotation, x = this.cornerRadius, y = this.dashLength, w = this.pattern, r = this.topRadius, t = this.bcn, A = k, v = k;
            "object" == typeof k && (A = k[0], v = k[k.length - 1]);
            var u, B, C, I, z, D, F, L, M, Q = m;
            w && (m = 0);
            var E, G, H, J, K = this.rotate;
            if (0 < Math.abs(h) || 0 < Math.abs(g))if (isNaN(r))F = v, v = e.adjustLuminosity(A, -.2), v = e.adjustLuminosity(A, -.2), u = e.polygon(b, [0, h, d + h, d, 0], [0, g, g, 0, 0], v, m, 1, p, 0, n), 0 < q && (M = e.line(b, [0, h, d + h], [0, g, g], p, q, l, y)), B = e.polygon(b, [0, 0, d, d, 0], [0, f, f, 0, 0], v, m, 1, p, 0, n), B.translate(h, g), 0 < q && (C = e.line(b, [h, h], [g, g + f], p, q, l, y)), I = e.polygon(b, [0, 0, h, h, 0], [0, f, f + g, g, 0], v, m, 1, p, 0, n), z = e.polygon(b, [d, d, d + h, d + h, d], [0, f, f + g, g, 0], v, m, 1, p, 0, n), 0 < q && (D = e.line(b, [d, d + h, d + h, d], [0, g, f + g, f], p, q, l, y)), v = e.adjustLuminosity(F, .2), F = e.polygon(b, [0, h, d + h, d, 0], [f, f + g, f + g, f, f], v, m, 1, p, 0, n), 0 < q && (L = e.line(b, [0, h, d + h], [f, f + g, f + g], p, q, l, y)); else {
                var N, O, P;
                K ? (N = f / 2, v = h / 2, P = f / 2, O = d + h / 2, G = Math.abs(f / 2), E = Math.abs(h / 2)) : (v = d / 2, N = g / 2, O = d / 2, P = f + g / 2 + 1, E = Math.abs(d / 2), G = Math.abs(g / 2));
                H = E * r;
                J = G * r;
                .1 < E && .1 < E && (u = e.circle(b, E, A, m, l, p, q, !1, G), u.translate(v, N));
                .1 < H && .1 < H && (F = e.circle(b, H, e.adjustLuminosity(A, .5), m, l, p, q, !1, J), F.translate(O, P))
            }
            m = Q;
            1 > Math.abs(f) && (f = 0);
            1 > Math.abs(d) && (d = 0);
            !isNaN(r) && (0 < Math.abs(h) || 0 < Math.abs(g)) ? (k = [A], k = {
                fill: k,
                stroke: p,
                "stroke-width": l,
                "stroke-opacity": q,
                "fill-opacity": m
            }, K ? (m = "M0,0 L" + d + "," + (f / 2 - f / 2 * r), l = " B", 0 < d && (l = " A"), e.VML ? (m += l + Math.round(d -
                    ...
                    2 + E) + "," + Math.round(G) + "," + Math.round(d / 2 - E) + "," + Math.round(-G) + "," + d + ",0,0,0") : (m += "A" + H + "," + J + ",0,0,0," + (d - d / 2 * (1 - r)) + "," + f + "L" + d + ",0", m += "A" + E + "," + G + ",0,0,1,0,0"), E = 180), b = b.path(m).attr(k), b.gradient("linearGradient", [A, e.adjustLuminosity(A, -.3), e.adjustLuminosity(A, -.3), A], E), K ? b.translate(h / 2, 0) : b.translate(0, g / 2)) : b = 0 === f ? e.line(b, [0, d], [0, 0], p, q, l, y) : 0 === d ? e.line(b, [0, 0], [0, f], p, q, l, y) : 0 < x ? e.rect(b, d, f, k, m, l, p, q, x, n, y) : e.polygon(b, [0, 0, d, d, 0], [0, f, f, 0, 0], k, m, l, p, q, n, !1, y);
            d = isNaN(r) ? 0 > f ? [u, M, B, C, I, z, D, F, L, b] : [F, L, B, C, I, z, u, M, D, b] : K ? 0 < d ? [u, b, F] : [F, b, u] : 0 > f ? [u, b, F] : [F, b, u];
            e.setCN(c, b, t + "front");
            e.setCN(c, B, t + "back");
            e.setCN(c, F, t + "top");
            e.setCN(c, u, t + "bottom");
            e.setCN(c, I, t + "left");
            e.setCN(c, z, t + "right");
            for (u = 0; u < d.length; u++)if (B = d[u])a.push(B), e.setCN(c, B, t + "element");
            w && b.pattern(w, NaN, c.path)
        }, width: function (a) {
            isNaN(a) && (a = 0);
            this.w = Math.round(a);
            this.draw()
    ...
    e.CategoryAxis = e.Class({
        inherits: e.AxisBase, construct: function (a) {
            ...
            if (e.ifArray(a)) {
                ...
                var d = this.start, f = this.labelFrequency, h = 0, g = this.end - d + 1, k = this.gridCountR, m = this.showFirstLabel, l = this.showLastLabel, p, q, n = "", n = e.extractPeriod(this.minPeriod), x = e.getPeriodDuration(n.period, n.count), y, w, r, t;
                y = this.rotate;
                p = this.firstDayOfWeek;
                q = this.boldPeriodBeginning;
                b = e.resetDateToMin(new Date(a[a.length - 1].time + 1.05 * x), this.minPeriod, 1, p).getTime();
                this.firstTime = c.firstTime;
                this.endTime > b && (this.endTime = b);
                t = this.minorGridEnabled;
                var A = this.gridAlpha, v, u = 0, B = 0;
                if (this.widthField)for (b = 0; b < this.data.length; b++)if (v = this.data[b]) {
                    var C = Number(this.data[b].dataContext[this.widthField]);
                    isNaN(C) || (u += C, v.widthValue = C)
                }
                if (this.parseDates && !this.equalSpacing)this.lastTime = a[a.length -
                1].time, this.maxTime = e.resetDateToMin(new Date(this.lastTime + 1.05 * x), this.minPeriod, 1, p).getTime(), this.timeDifference = this.endTime - this.startTime, this.parseDatesDraw(); else if (!this.parseDates) {
                    if (this.cellWidth = this.getStepWidth(g), g < k && (k = g), h += this.start, this.stepWidth = this.getStepWidth(g), 0 < k)for (k = Math.floor(g / k), g = this.chooseMinorFrequency(k), n = h, n / 2 == Math.round(n / 2) && n--, 0 > n && (n = 0), a = 0, this.end - n + 1 >= this.autoRotateCount && (this.labelRotationR = this.autoRotateAngle), b = n; b <= this.end + 2; b++) {
                        q = !1;
                        0 <= b && b < this.data.length ? (w = this.data[b], n = w.category, q = w.forceShow) : n = "";
                        if (t && !isNaN(g))if (b / g == Math.round(b / g) || q)b / k == Math.round(b / k) || q || (this.gridAlpha = this.minorGridAlpha, n = void 0); else continue; else if (b / k != Math.round(b / k) && !q)continue;
                        p = this.getCoordinate(b - h);
                        r = 0;
                        "start" == this.gridPosition && (p -= this.cellWidth / 2, r = this.cellWidth / 2);
                        q = !0;
                        v = r;
                        "start" == this.tickPosition && (v = 0, q = !1, r = 0);
                        if (b == d && !m || b == this.end && !l)n = void 0;
                        Math.round(a / f) != a / f && (n = void 0);
                        a++;
                        C = this.cellWidth;
                        y && (C = NaN, this.ignoreAxisWidth || !c.autoMargins) && (C = "right" == this.position ? c.marginRight : c.marginLeft, C -= this.tickLength + 10);
                        ...
                        isNaN(w.widthValue) || (w.percentWidthValue = w.widthValue / u * 100, C = this.rotate ? this.height * w.widthValue / u : this.width * w.widthValue / u, p = B, B += C, r = C / 2);
                        r = new this.axisItemRenderer(this, p, n, q, C, r, void 0, x, v, !1, w.labelColor, w.className);
                        r.serialDataItem = w;
                        this.pushAxisItem(r);
                        this.gridAlpha = A
                    }
                    ...
                    f = b.period;
                    y = b.count;
                    b = e.getPeriodDuration(f, y);
                    b < x && (f = n.period, y = n.count, b = x);
                    w = f;
                    "WW" == w && (w = "DD");
                    this.stepWidth = this.getStepWidth(g);
                    k = Math.ceil(this.timeDifference / b) + 1;
                    x = e.resetDateToMin(new Date(this.startTime - b), f, y, p).getTime();
                    this.cellWidth = this.getStepWidth(g);
                    n = Math.round(x / b);
                    d = -1;
                    n / 2 == Math.round(n / 2) && (d = -2, x -= b);
                    n = this.start;
                    n / 2 == Math.round(n / 2) && n--;
                    0 > n && (n = 0);
                    A = this.end + 2;
                    ...
                    a = n;
                    if (this.data[n].time != e.resetDateToMin(new Date(this.data[n].time), f, y, p).getTime())for (p = 0, v = x, b = n; b < A; b++)g = this.data[b].time, this.checkPeriodChange(f, y, g, v) && (p++, 2 <= p && (a = b, b = A), v = g);
                    t && 1 < y && (g = this.chooseMinorFrequency(y), e.getPeriodDuration(f, g));
                    if (0 < this.gridCountR)for (b = n; b < A; b++)if (g = this.data[b].time, this.checkPeriodChange(f, y, g, x) && b >= a) {
                        p = this.getCoordinate(b - this.start);
                        t = !1;
                        this.nextPeriod[w] && (t = this.checkPeriodChange(this.nextPeriod[w], 1, g, x, w));
                        x = !1;
                        t && this.markPeriodChange ? (t = this.dateFormatsObject[this.nextPeriod[w]], x = !0) : t = this.dateFormatsObject[w];
                        n = e.formatDate(new Date(g), t, c);
                        if (b == d && !m || b == k && !l)n = " ";
                        B ? B = !1 : (q || (x = !1), p - this.previousPos > this.safeDistance * Math.cos(this.labelRotationR * Math.PI /
                            180) && (this.labelFunction && (n = this.labelFunction(n, new Date(g), this, f, y, r)), this.boldLabels && (x = !0), r = new this.axisItemRenderer(this, p, n, void 0, void 0, void 0, void 0, x), t = r.graphics(), this.pushAxisItem(r), t = t.getBBox().width, e.isModern || (t -= p), this.previousPos = p + t));
                        r = x = g
                    }
                }
                for (b = 0; b < this.data.length; b++)if (v = this.data[b])m = this.parseDates && !this.equalSpacing ? Math.round((v.time - this.startTime) * this.stepWidth + this.cellWidth / 2) : this.getCoordinate(b - h), isNaN(v.widthValue) || (v.percentWidthValue = v.widthValue /
                    u * 100, m = this.rotate ? this.height * v.widthValue / u : this.width * v.widthValue / u), v.x[this.id] = m;
                m = this.guides.length;
                for (b = 0; b < m; b++)l = this.guides[b], q = k = k = t = d = NaN, u = l.above, l.toCategory && (k = c.getCategoryIndexByValue(l.toCategory), isNaN(k) || (d = this.getCoordinate(k - h), l.expand && (d += this.cellWidth / 2), r = new this.axisItemRenderer(this, d, "", !0, NaN, NaN, l), this.pushAxisItem(r, u))), l.category && (q = c.getCategoryIndexByValue(l.category), isNaN(q) || (t = this.getCoordinate(q - h), l.expand && (t -= this.cellWidth / 2), k = (d - t) / 2,
                    r = new this.axisItemRenderer(this, t, l.label, !0, NaN, k, l), this.pushAxisItem(r, u))), q = c.dataDateFormat, l.toDate && (l.toDate = e.getDate(l.toDate, q), this.equalSpacing ? (k = c.getClosestIndex(this.data, "time", l.toDate.getTime(), !1, 0, this.data.length - 1), isNaN(k) || (d = this.getCoordinate(k - h))) : d = (l.toDate.getTime() - this.startTime) * this.stepWidth, r = new this.axisItemRenderer(this, d, "", !0, NaN, NaN, l), this.pushAxisItem(r, u)), l.date && (l.date = e.getDate(l.date, q), this.equalSpacing ? (q = c.getClosestIndex(this.data, "time", l.date.getTime(), !1, 0, this.data.length - 1), isNaN(q) || (t = this.getCoordinate(q - h))) : t = (l.date.getTime() - this.startTime) * this.stepWidth, k = (d - t) / 2, q = !0, l.toDate && (q = !1), r = "H" == this.orientation ? new this.axisItemRenderer(this, t, l.label, q, 2 * k, NaN, l) : new this.axisItemRenderer(this, t, l.label, !1, NaN, k, l), this.pushAxisItem(r, u)), (0 < d || 0 < t) && (d < this.width || t < this.width) && (d = new this.guideFillRenderer(this, t, d, l), t = d.graphics(), this.pushAxisItem(d, u), l.graphics = t, t.index = b, l.balloonText && this.addEventListeners(t,
                    l))
            }
            this.axisCreated = !0;
            c = this.x;
            ...
            var b = this.data, c = this.chart, d = c.rotate, f = this.stepWidth;
            this.parseDates && !this.equalSpacing ? (a = this.startTime + Math.round(a / f) - this.minDuration() / 2, c = c.getClosestIndex(b,
                "time", a, !1, this.start, this.end + 1)) : (this.startOnAxis || (a -= f / 2), c = this.start + Math.round(a / f));
